...
let isRaining = true
let isSunny = true
let isNiceWeather = walk
let walk = false

// if both temp is greater then or equal to 82 and it is sunny are true, and "!=" means that is raining and is sunny cannot be equal

if temp >= 82 && isSunny != isRaining {
    walk == true
    print("I'm going on a walk")
} else {
    print("I'm not going on a walk!")
