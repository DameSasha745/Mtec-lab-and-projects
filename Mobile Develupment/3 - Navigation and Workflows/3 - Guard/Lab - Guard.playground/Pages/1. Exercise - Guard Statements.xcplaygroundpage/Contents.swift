...
func createUser() -> User? {
    guard let fristNameUnwraped = firstNameTextField.text, let lastNameUnwraped = lastNameTextField.text, let ageTextUnwraped = ageTextField.text else {
