...
// becouse foo is not within the scope.
...
// becouse "x" is both within and outside the curly braces.
...
func greeting(greeting: String?, name: String) {
    if let unrapedgreeting = greeting {
...
class Car {
    ...
    init(make: String, model: String, year: Int) {
        ...
        let myCar = Car(make: "subaru", model: "outback", year: 2016)
        print(myCar.make)
    }
}
