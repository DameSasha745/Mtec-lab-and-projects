...
// becouse the "34e" contains both an Int and string and wont work together, Ints and strings cannot be stated togeather.
...
if let age = userAge {
    ...
    print("invalid age input: \(userInputAge)")
}
/*:
