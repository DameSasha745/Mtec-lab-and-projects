...
func mealType(meal: String) -> Meal? {
    return meals[meal]
    
    print(mealType(meal: "Breakfast"))
    print(mealType(meal: "Lunch"))
    ...
    func mealLogged(meal: String) -> [String: Any] {
        let mealLog = UserDefaults.standard.dictionary(forKey: "mealLog")
