 ...
 */
let nameInCaps = "Sasha Cummings"
let myName = "sasha cummings"
if nameInCaps == myName {
    print("they two are the equal.")
} else if nameInCaps != myName {
 ...
 */
let upperCaps = "Sasha Cummings"
let lowercased = "sasha cummings"

if upperCaps == lowercased {
    print("They are the same!")
} else if upperCaps != lowercased {
