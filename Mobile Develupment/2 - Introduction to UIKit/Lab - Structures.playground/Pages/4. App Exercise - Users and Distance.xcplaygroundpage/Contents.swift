...
var SashaCummings = User(name: "Sasha Cummings", age: 32, hight: 5.5, weight: 177.67, activityLevel: 2)
print(SashaCummings)
/*:
...
struct Distance {
    ...
    init(meters: Double) {
        self.meters = meters
        self.feet = (meters * 3.2)
    }
        
    init(feet: Double) {
        self.feet = feet
        self.meters = (feet / 3.2)
        }
    }
...
var halfAMile = Distance(meters: 800)
print(halfAMile)
/*:
