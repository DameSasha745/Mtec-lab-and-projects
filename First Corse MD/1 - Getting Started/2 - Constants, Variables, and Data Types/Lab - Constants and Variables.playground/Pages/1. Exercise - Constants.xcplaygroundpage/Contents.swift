 ...
 */
let nomberOfFriends = 450
print(nomberOfFriends)
...
var nomberOfFriends1 = 450
nomberOfFriends1 = 397
...
print("it didnt compile at first becouse the nomber of friends was entered as a constant where as a var is a varuable that can change its value and be updated")
