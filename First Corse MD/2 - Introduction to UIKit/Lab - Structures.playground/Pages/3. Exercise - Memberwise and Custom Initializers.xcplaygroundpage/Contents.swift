...
let favorateBook = Book(title: "Lioness Rampent", author: "Tamora Pierce", pages: 320, price: 6.39)
print(favorateBook)
/*:
...
let macBookPro = Laptop(yearPurchased: 2024)

let computerDesktop = Laptop(yearPurchased: 2019)

print(macBookPro)

print(computerDesktop)
/*:
...
var myHeight = Height(heightInInches: 5.5)
