...
let city = "Orem"
let state = "Utah"
let home = "843 s 200 n"
print(city, state, home)
 ...
 */
let FullName = "sasha Cummings"
let age: Int = 32
print("my name is \(FullName) and after my next birthday I will be \(age) years old")
/*:
