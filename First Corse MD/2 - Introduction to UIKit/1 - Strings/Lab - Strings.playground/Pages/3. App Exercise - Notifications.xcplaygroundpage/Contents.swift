...
let newBest = 15125
let congratulations = newBest
print("congratulations, \(fullName)! You beat your previouse daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!")
